...
This file gives Claude Code and CLAUDE.md-compatible agents the working doctrine for this repo.

> **Kept in sync with `AGENTS.md`.** Edit both together. The content intentionally stays short; narrow, evolving details belong in `.codex/skills/*/SKILL.md`.
