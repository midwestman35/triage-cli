...
| `Tickets/<id>/DRAFTS.md` | CONFIRM-gated manual customer/internal/Jira workspace | Keep with ticket folder |
...
| `DD_SITE`, `DD_CALL_CENTER_TAG`, `DD_STATION_TAG`, `DD_CALL_ID_TAG`, `DD_COMPONENT_TAG` | Datadog broad and focused query settings. |
